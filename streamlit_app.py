...
# =========================
st.subheader("Animasi Partikel Gas")
...
for i in range(15):
    ...
    bola_html += (
        f'<div class="bola" '
        f'style="left:{left}px; top:{top}px;"></div>'
    )

st.markdown(
    f'<div class="kotak">{bola_html}</div>',
    unsafe_allow_html=True
)

st.info(
    "Partikel gas bergerak bebas dan saling bertumbukan sesuai teori gas ideal."
)
